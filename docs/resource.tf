// quero criar um resource group, sg, vnet, subnet usando a azure como provider, e depois criar uma vm linux usando a imagem ubuntu 22.04 LTS, e usar uma chave ssh pra autenticação
